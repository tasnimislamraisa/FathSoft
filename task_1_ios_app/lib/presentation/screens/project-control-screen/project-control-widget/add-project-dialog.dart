              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _textField("Enter location"),
                    _fieldLabel("Contact Number:"),
                    _textField("(603) 555-0123"),
                    _fieldLabel("Project Start Date:"),
                    _dateField(),
                    _fieldLabel("Approximate Hand Over Date:"),
                    _dateField(),
                    _fieldLabel("Project Code:"),
                    _textField("#6789", readOnly: true),
                    _fieldLabel("Project Type:"),
                    _dropdownPlaceholder("Select Project Type"),
                    _fieldLabel("Stage:"),
                    _dropdownPlaceholder("Select stage"),
                    _fieldLabel("Status:"),
                    _dropdownPlaceholder("Select status"),
                    _fieldLabel("Logo:"),
                    _uploadField(),
                    _fieldLabel("Architecture Drawing File:"),
                    _uploadField(),
                    AddButton(
                        title: "Add",
                        onTap: () {
